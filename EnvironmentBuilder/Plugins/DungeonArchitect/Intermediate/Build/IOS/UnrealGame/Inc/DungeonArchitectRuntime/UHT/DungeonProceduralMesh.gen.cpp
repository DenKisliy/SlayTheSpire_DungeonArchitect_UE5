...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FDAProcMeshLODData_Statics::NewProp_MeshSections_Inner = { "MeshSections", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FDAProcMeshSection, METADATA_PARAMS(0, nullptr) }; // 1193485395
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FDAProcMeshLODData_Statics::NewProp_MeshSections = { "MeshSections", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDAProcMeshLODData, MeshSections), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MeshSections_MetaData), NewProp_MeshSections_MetaData) }; // 1193485395
...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UDAProcMeshComponent_CreateMeshSection_Statics::NewProp_Vertices = { "Vertices", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DAProcMeshComponent_eventCreateMeshSection_Parms, Vertices), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Vertices_MetaData), NewProp_Vertices_MetaData) }; // 3315301172
...
struct Z_Construct_UClass_UDAProcMeshComponent_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UDAProcMeshComponent_AddCollisionConvexMesh, "AddCollisionConvexMesh" }, // 1765817230
		{ &Z_Construct_UFunction_UDAProcMeshComponent_ClearAllMeshSections, "ClearAllMeshSections" }, // 3724935077
		{ &Z_Construct_UFunction_UDAProcMeshComponent_ClearCollisionConvexMeshes, "ClearCollisionConvexMeshes" }, // 2775822173
		{ &Z_Construct_UFunction_UDAProcMeshComponent_ClearMeshSection, "ClearMeshSection" }, // 1283411631
		{ &Z_Construct_UFunction_UDAProcMeshComponent_CreateMeshSection, "CreateMeshSection" }, // 586716336
		{ &Z_Construct_UFunction_UDAProcMeshComponent_GetNumSections, "GetNumSections" }, // 1380816512
		{ &Z_Construct_UFunction_UDAProcMeshComponent_IsMeshSectionVisible, "IsMeshSectionVisible" }, // 2957950312
		{ &Z_Construct_UFunction_UDAProcMeshComponent_SetMeshSectionVisible, "SetMeshSectionVisible" }, // 3944099672
	};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DungeonArchitect_Source_DungeonArchitectRuntime_Public_Frameworks_Meshing_Geometry_DungeonProceduralMesh_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FDAProcMeshTangent::StaticStruct, Z_Construct_UScriptStruct_FDAProcMeshTangent_Statics::NewStructOps, TEXT("DAProcMeshTangent"), &Z_Registration_Info_UScriptStruct_DAProcMeshTangent, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDAProcMeshTangent), 1173078210U) },
		{ FDAProcMeshVertex::StaticStruct, Z_Construct_UScriptStruct_FDAProcMeshVertex_Statics::NewStructOps, TEXT("DAProcMeshVertex"), &Z_Registration_Info_UScriptStruct_DAProcMeshVertex, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDAProcMeshVertex), 3315301172U) },
		{ FDAProcMeshSection::StaticStruct, Z_Construct_UScriptStruct_FDAProcMeshSection_Statics::NewStructOps, TEXT("DAProcMeshSection"), &Z_Registration_Info_UScriptStruct_DAProcMeshSection, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDAProcMeshSection), 1193485395U) },
		{ FDAProcMeshLODData::StaticStruct, Z_Construct_UScriptStruct_FDAProcMeshLODData_Statics::NewStructOps, TEXT("DAProcMeshLODData"), &Z_Registration_Info_UScriptStruct_DAProcMeshLODData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDAProcMeshLODData), 2446202270U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UDAProcMeshComponent, UDAProcMeshComponent::StaticClass, TEXT("UDAProcMeshComponent"), &Z_Registration_Info_UClass_UDAProcMeshComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDAProcMeshComponent), 1578057966U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DungeonArchitect_Source_DungeonArchitectRuntime_Public_Frameworks_Meshing_Geometry_DungeonProceduralMesh_h_1234873326(TEXT("/Script/DungeonArchitectRuntime"),
	Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DungeonArchitect_Source_DungeonArchitectRuntime_Public_Frameworks_Meshing_Geometry_DungeonProceduralMesh_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DungeonArchitect_Source_DungeonArchitectRuntime_Public_Frameworks_Meshing_Geometry_DungeonProceduralMesh_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DungeonArchitect_Source_DungeonArchitectRuntime_Public_Frameworks_Meshing_Geometry_DungeonProceduralMesh_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DungeonArchitect_Source_DungeonArchitectRuntime_Public_Frameworks_Meshing_Geometry_DungeonProceduralMesh_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration

...
// IWYU pragma: private, include "Frameworks/LevelStreaming/DungeonLevelStreamer.h"
...
#define FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DungeonArchitect_Source_DungeonArchitectRuntime_Public_Frameworks_LevelStreaming_DungeonLevelStreamer_h_46_GENERATED_BODY \
...
#define CURRENT_FILE_ID FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DungeonArchitect_Source_DungeonArchitectRuntime_Public_Frameworks_LevelStreaming_DungeonLevelStreamer_h
...
template<> struct TIsUEnumClass<EDungeonLevelStreamingLoadingStrategy> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EDungeonLevelStreamingStrategy> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EDungeonLevelStreamLoadMethod> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EDungeonLevelStreamUnloadMethod> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EDungeonLevelStreamChunkSelection> { enum { Value = true }; };

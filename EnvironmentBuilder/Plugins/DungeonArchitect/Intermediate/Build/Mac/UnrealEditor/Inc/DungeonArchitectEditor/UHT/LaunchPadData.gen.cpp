...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DungeonArchitect_Source_DungeonArchitectEditor_Public_Core_Editors_LaunchPad_Data_LaunchPadData_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ ELaunchPagePageLayout_StaticEnum, TEXT("ELaunchPagePageLayout"), &Z_Registration_Info_UEnum_ELaunchPagePageLayout, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2867273744U) },
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FLaunchPadCategoryItem::StaticStruct, Z_Construct_UScriptStruct_FLaunchPadCategoryItem_Statics::NewStructOps, TEXT("LaunchPadCategoryItem"), &Z_Registration_Info_UScriptStruct_LaunchPadCategoryItem, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLaunchPadCategoryItem), 276479771U) },
		{ FLaunchPadCategories::StaticStruct, Z_Construct_UScriptStruct_FLaunchPadCategories_Statics::NewStructOps, TEXT("LaunchPadCategories"), &Z_Registration_Info_UScriptStruct_LaunchPadCategories, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLaunchPadCategories), 3806182976U) },
		{ FLaunchPadPageHeader::StaticStruct, Z_Construct_UScriptStruct_FLaunchPadPageHeader_Statics::NewStructOps, TEXT("LaunchPadPageHeader"), &Z_Registration_Info_UScriptStruct_LaunchPadPageHeader, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLaunchPadPageHeader), 1601661406U) },
		{ FLaunchPadPageLayout_CardGrid_CardInfo::StaticStruct, Z_Construct_UScriptStruct_FLaunchPadPageLayout_CardGrid_CardInfo_Statics::NewStructOps, TEXT("LaunchPadPageLayout_CardGrid_CardInfo"), &Z_Registration_Info_UScriptStruct_LaunchPadPageLayout_CardGrid_CardInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLaunchPadPageLayout_CardGrid_CardInfo), 2213686548U) },
		{ FLaunchPadPageLayout_CardGrid_Category::StaticStruct, Z_Construct_UScriptStruct_FLaunchPadPageLayout_CardGrid_Category_Statics::NewStructOps, TEXT("LaunchPadPageLayout_CardGrid_Category"), &Z_Registration_Info_UScriptStruct_LaunchPadPageLayout_CardGrid_Category, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLaunchPadPageLayout_CardGrid_Category), 827185336U) },
		{ FLaunchPadPageLayout_CardGrid::StaticStruct, Z_Construct_UScriptStruct_FLaunchPadPageLayout_CardGrid_Statics::NewStructOps, TEXT("LaunchPadPageLayout_CardGrid"), &Z_Registration_Info_UScriptStruct_LaunchPadPageLayout_CardGrid, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLaunchPadPageLayout_CardGrid), 1896629870U) },
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DungeonArchitect_Source_DungeonArchitectEditor_Public_Core_Editors_LaunchPad_Data_LaunchPadData_h_761068952(TEXT("/Script/DungeonArchitectEditor"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DungeonArchitect_Source_DungeonArchitectEditor_Public_Core_Editors_LaunchPad_Data_LaunchPadData_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DungeonArchitect_Source_DungeonArchitectEditor_Public_Core_Editors_LaunchPad_Data_LaunchPadData_h_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DungeonArchitect_Source_DungeonArchitectEditor_Public_Core_Editors_LaunchPad_Data_LaunchPadData_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_DungeonArchitect_Source_DungeonArchitectEditor_Public_Core_Editors_LaunchPad_Data_LaunchPadData_h_Statics::EnumInfo));
// End Registration

...
// Begin Registration
struct Z_CompiledInDeferFile_FID_EnvironmentBuilder_Plugins_DungeonArchitect_Source_DungeonArchitectEditor_Public_Core_Editors_CanvasEditor_DungeonCanvasEditorSettings_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EDungeonCanvasEditorBackgrounds_StaticEnum, TEXT("EDungeonCanvasEditorBackgrounds"), &Z_Registration_Info_UEnum_EDungeonCanvasEditorBackgrounds, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2376436039U) },
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		...
		{ Z_Construct_UClass_UDungeonCanvasEditorSettings, UDungeonCanvasEditorSettings::StaticClass, TEXT("UDungeonCanvasEditorSettings"), &Z_Registration_Info_UClass_UDungeonCanvasEditorSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDungeonCanvasEditorSettings), 3157320382U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_EnvironmentBuilder_Plugins_DungeonArchitect_Source_DungeonArchitectEditor_Public_Core_Editors_CanvasEditor_DungeonCanvasEditorSettings_h_2696516204(TEXT("/Script/DungeonArchitectEditor"),
	Z_CompiledInDeferFile_FID_EnvironmentBuilder_Plugins_DungeonArchitect_Source_DungeonArchitectEditor_Public_Core_Editors_CanvasEditor_DungeonCanvasEditorSettings_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_EnvironmentBuilder_Plugins_DungeonArchitect_Source_DungeonArchitectEditor_Public_Core_Editors_CanvasEditor_DungeonCanvasEditorSettings_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_EnvironmentBuilder_Plugins_DungeonArchitect_Source_DungeonArchitectEditor_Public_Core_Editors_CanvasEditor_DungeonCanvasEditorSettings_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_EnvironmentBuilder_Plugins_DungeonArchitect_Source_DungeonArchitectEditor_Public_Core_Editors_CanvasEditor_DungeonCanvasEditorSettings_h_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_EnvironmentBuilder_Plugins_DungeonArchitect_Source_DungeonArchitectEditor_Public_Core_Editors_CanvasEditor_DungeonCanvasEditorSettings_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_EnvironmentBuilder_Plugins_DungeonArchitect_Source_DungeonArchitectEditor_Public_Core_Editors_CanvasEditor_DungeonCanvasEditorSettings_h_Statics::EnumInfo));
// End Registration

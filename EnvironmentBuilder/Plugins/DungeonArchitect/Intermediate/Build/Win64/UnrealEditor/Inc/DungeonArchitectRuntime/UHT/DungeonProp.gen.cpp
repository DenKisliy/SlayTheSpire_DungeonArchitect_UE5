...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FPropTypeData_Statics::NewProp_ChildSockets_Inner = { "ChildSockets", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FPropChildSocketData, METADATA_PARAMS(0, nullptr) }; // 3236230267
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FPropTypeData_Statics::NewProp_ChildSockets = { "ChildSockets", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPropTypeData, ChildSockets), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ChildSockets_MetaData), NewProp_ChildSockets_MetaData) }; // 3236230267
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_EnvironmentBuilder_Plugins_DungeonArchitect_Source_DungeonArchitectRuntime_Public_Core_DungeonProp_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FDAMarkerInfo::StaticStruct, Z_Construct_UScriptStruct_FDAMarkerInfo_Statics::NewStructOps, TEXT("DAMarkerInfo"), &Z_Registration_Info_UScriptStruct_DAMarkerInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDAMarkerInfo), 1218632746U) },
		{ FPropChildSocketData::StaticStruct, Z_Construct_UScriptStruct_FPropChildSocketData_Statics::NewStructOps, TEXT("PropChildSocketData"), &Z_Registration_Info_UScriptStruct_PropChildSocketData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPropChildSocketData), 3236230267U) },
		{ FPropTypeData::StaticStruct, Z_Construct_UScriptStruct_FPropTypeData_Statics::NewStructOps, TEXT("PropTypeData"), &Z_Registration_Info_UScriptStruct_PropTypeData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPropTypeData), 761812739U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_EnvironmentBuilder_Plugins_DungeonArchitect_Source_DungeonArchitectRuntime_Public_Core_DungeonProp_h_1540494139(TEXT("/Script/DungeonArchitectRuntime"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_EnvironmentBuilder_Plugins_DungeonArchitect_Source_DungeonArchitectRuntime_Public_Core_DungeonProp_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_EnvironmentBuilder_Plugins_DungeonArchitect_Source_DungeonArchitectRuntime_Public_Core_DungeonProp_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration

...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ADungeonMinimap2D_Statics::NewProp_OverlayIcons = { "OverlayIcons", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ADungeonMinimap2D, OverlayIcons), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OverlayIcons_MetaData), NewProp_OverlayIcons_MetaData) }; // 2305651181
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_EnvironmentBuilder_Plugins_DungeonArchitect_Source_DungeonArchitectRuntime_Public_Frameworks_Minimap_DungeonMinimap2D_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ADungeonMinimapBase, ADungeonMinimapBase::StaticClass, TEXT("ADungeonMinimapBase"), &Z_Registration_Info_UClass_ADungeonMinimapBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ADungeonMinimapBase), 2720865479U) },
		{ Z_Construct_UClass_ADungeonMinimap2D, ADungeonMinimap2D::StaticClass, TEXT("ADungeonMinimap2D"), &Z_Registration_Info_UClass_ADungeonMinimap2D, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ADungeonMinimap2D), 2396745942U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_EnvironmentBuilder_Plugins_DungeonArchitect_Source_DungeonArchitectRuntime_Public_Frameworks_Minimap_DungeonMinimap2D_h_1569482854(TEXT("/Script/DungeonArchitectRuntime"),
	Z_CompiledInDeferFile_FID_EnvironmentBuilder_Plugins_DungeonArchitect_Source_DungeonArchitectRuntime_Public_Frameworks_Minimap_DungeonMinimap2D_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_EnvironmentBuilder_Plugins_DungeonArchitect_Source_DungeonArchitectRuntime_Public_Frameworks_Minimap_DungeonMinimap2D_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration

...
void EmptyLinkFunctionForGeneratedCodeDungeonArchitectRuntime_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_DungeonArchitectRuntime()
	{
		if (!Z_Registration_Info_UPackage__Script_DungeonArchitectRuntime.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_DungeonArchitectRuntime_DungeonViewportFreeCameraBack__DelegateSignature,
			};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_DungeonArchitectRuntime(Z_Construct_UPackage__Script_DungeonArchitectRuntime, TEXT("/Script/DungeonArchitectRuntime"), Z_Registration_Info_UPackage__Script_DungeonArchitectRuntime, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x9D43B354, 0x7D84BD50));
